...
var sendEmail = (data) => {
    ...
    "Your profile has been created successfully on our application. You need to verify that this is your email address before using your account by clicking on this link:" +"\n"+ link + "\n\n\n"+
